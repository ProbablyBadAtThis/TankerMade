...
public class KnittingToolInventoryItem
{
    ...
    protected KnittingToolInventoryItem()
    {
    }

    public KnittingToolInventoryItem(Guid id, Guid userId, string brandName, string typeName)
    {
        Id = id;
        UserId = userId;
    ...
    public void MergeDetails(string size, string description, int quantity, decimal? price, bool isSalePrice)
    {
