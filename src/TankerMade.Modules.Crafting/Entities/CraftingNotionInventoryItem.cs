...
public class CraftingNotionInventoryItem
{
    ...
    protected CraftingNotionInventoryItem()
    {
    }

    public CraftingNotionInventoryItem(Guid id, Guid userId, string brandName, string typeName)
    {
        Id = id;
        UserId = userId;
