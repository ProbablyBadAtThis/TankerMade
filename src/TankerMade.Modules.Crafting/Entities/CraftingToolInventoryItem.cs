...
public class CraftingToolInventoryItem
{
    ...
    protected CraftingToolInventoryItem()
    {
    }

    public CraftingToolInventoryItem(Guid id, Guid userId, string brandName, string typeName)
    {
        Id = id;
        UserId = userId;
